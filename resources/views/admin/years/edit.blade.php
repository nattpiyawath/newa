...
@section('title', 'Edit Year - '.$years->name)
      ...
      <div class="col-md-12">
            <div class="panel panel-default card-view">
                  <div class="panel-heading">
                        <div class="pull-left">
                              <h6 class="panel-title txt-dark">Update Year: {{$years->name}}</h6>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-wrap">
                                                      ...
                                                      {!! Form::open(['route' => ['years.update', $years->id], 'method' => 'PATCh']) !!}
                                                	...
                                                	{{ csrf_field() }}
                                                      ...
                                                      <div class="form-group">
                                                      	...
                                                      	<input type="text" name="year" value="{{ $years->year }}" placeholder="Enter Year" class="form-control">
                                                      </div>
