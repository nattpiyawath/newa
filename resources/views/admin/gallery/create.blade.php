                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default card-view">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">Create A Slider</h6>
                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2"> 
                                                                    ...
                                                                    <label for="post-type" class="control-label mb-10">Select Post Type</label>
                                                                        <select class="form-control" id="post-type" id="post-type" name="post_type" required>
                                                                                <option value="">-----</option>
                                                                ...
                                                                <div class="col-md-3 post-list-main"> 
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control selectpicker" id="post-list" data-live-search="true" data-placeholder="Choose a Post" name="page_id" required>
                                                                            <option value="">-----</option>
                                                                            @foreach($page as $pages)
                                                                                <option  class="post-{{$pages->type}}" value="{{$pages->id}}">{{$pages->title}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2"> 
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control selectpicker" id="choose-layout" name="layout">
                                                                            <option value="1">Banners 1, 2,..</option>
                                                                            <option value="2">Product Feature</option>
                                                                            <option value="3">Event Gallery</option>
                                                                            <option value="4">Model KV</option>
                                                                            <option value="5">4JOYS</option>
                                                                        </select>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label for="select-page" class="control-label mb-10">Translate Of </label>
                                                            ...
                                                            <div id="addRow">
                                                                ...
                                                                <div class="row" style="padding-top:20px!important">
                                                                    <div class="col-md-1">
                                                                      ...
                                                                      <div class="col-md-3">
                                                                          <div class="form-group" style="margin-bottom:0;">
                                                                              <label class="control-label mb-10">Image Title</label>
                                                                          </div>
                                                                      </div>
    
                                                                      <div class="col-md-2">
                                                                          <div class="form-group">
                                                                              <label class="control-label mb-10">Image Caption</label>
                                                                          </div>
                                                                      </div>
                                                                      
                                                                      <div class="col-md-1">
                                                                          <div class="form-group">
                                                                              <label class="control-label mb-10">Image Link</label>
                                                                          </div>
                                                                      </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-1">
                                                                          <div class="form-group" style="margin-bottom:0;">
                                                                            <input type="number" class="form-control" name="image_order[]" value="{{ old('image_order') }}" />
                                                                          </div>
                                                                      </div>
