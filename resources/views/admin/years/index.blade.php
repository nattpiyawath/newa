...
@section('title', 'Years Management')
...
<!-- Title -->
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 admin-head-title">
            <h5 class="txt-dark">Year</h5>
            <a href="{{url('admin/years/create?lang='.$lang)}}" class="btn btn-primary" style="margin-bottom:10px;">Add Year</a>
        </div>
        <!-- Breadcrumb -->
                        ...
                        <div class="table-responsive">
                            ...
                            @if($years->count())
						 		@foreach($years as $year)
                                    ...
                                    <tr>
                                        <td><a href="#" target="_blank" class="page-title" title="{{ $year->name }}">
                                            {{ $year->year }}
                                        </a></td>
                                        <th>{{$year->lang_code}}</th>
                                        <td>Last Modified <br>
                                            @php
                                                $updated_date = $year->updated_at;
                                        ...
                                        <td class="text-nowrap center">
                                            ...
                                            <a href="{{ route('years.edit', $year->id) }}?lang={{$lang}}" class="btn btn-default btn-icon-anim btn-sm btn-circle" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a href="#" class="btn btn-danger btn-icon-anim btn-sm btn-circle btn-delete" data-toggle="tooltip" data-type="category" data-name="{{$year->year}}" data-id="{{$year->id}}" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
