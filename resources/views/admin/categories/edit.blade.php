                                                ...
                                                <div class="form-wrap">
                                                	...
                                                	{{ csrf_field() }}
                                                      ...
                                                      <div class="form-group">
                                                      	...
                                                      	<input type="text" name="name" value="{{ $category->name }}" placeholder="Enter Your Category Name" class="form-control">
                                                      </div>
                                                      
                                                      <div class="form-group">
                                                      	<label for="slug">Category Slug</label>
                                                      	<input type="text" name="slug" value="{{ $category->slug }}" placeholder="Enter Your Category Slug" class="form-control">
                                                      </div>
