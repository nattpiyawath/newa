      ...
      <div class="col-md-12">
            <div class="panel panel-default card-view">
                  <div class="panel-heading">
                        <div class="pull-left">
                              <h6 class="panel-title txt-dark">Add Regions</h6>
                        </div>
                                                ...
                                                <form action="{{ route('regions.store') }}" method="POST">
                                                	...
                                                	{{ csrf_field() }}
                                                      ...
                                                      <div class="form-group">
                                                      	...
                                                      	<input type="text" name="region" placeholder="Enter Region" class="form-control text-danger" value="{{old('region')}}">
                                                      </div>

                                                      <div class="from-group">
                                                      	 <div class="text-right">
                                                            <a class="btn btn-default btn-close" href="{{url('admin/region?lang='.$lang)}}"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back</a>
