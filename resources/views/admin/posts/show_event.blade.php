      ...
      <div class="row">
        <div class="col-lg-12 blog-content">
                    <div class="post-heading">
                        <h1 class="detail-post-title">{{ $blog->title }}</h1>  
                    </div>
                    <div class="date-time">
...
<h1 class="head-titel-page ">OTHER RELATED New</h1>
<div class="story owl-carousel owl-theme container" style="padding:0;">
  ...
  <div class="card-grid-space">
    <a class="card" href="<?php echo URL('en/blog').'/'.$value->slug?>" style="--bg-img: url('<?php echo myupload().$value->thumbnail ;?>')">
    
        <p class="postype">Event</p>
        <h1 class="title-event"><?php echo $value->title; ?></h1>
        <p class="description-text"><?php echo $value->excerpt; ?></p>
