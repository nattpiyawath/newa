...
<!-- Title -->
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 admin-head-title">
            <h5 class="txt-dark">Post Category</h5>
            <a href="{{url('admin/category/create?lang='.$lang)}}" class="btn btn-primary" style="margin-bottom:10px;">New Category</a>
        </div>
        <!-- Breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                      <ol class="breadcrumb">
                        <li><a href="{{url('admin/dashboard')}}">Dashboard</a></li>
                        <li class="active"><span>Post Category</span></li>
        			</ol>
        </div>
        <!-- /Breadcrumb -->
    </div>
                        ...
                        <div class="table-responsive">
                            ...
                            @if($categories->count())
						 		@foreach($categories as $category)
                                    ...
                                    <tr>
                                        <td><a href="#" target="_blank" class="page-title" title="{{ $category->name }}">
                                            {{ $category->name }}
                                        </a></td>
                                        <td><a href="#" target="_blank" class="page-title" title="{{ $category->name }}">
                                            {{ $category->slug }}
                                        </a></td>
                                        <th>{{$category->lang_code}}</th>
                                        <td>Last Modified <br>
                                            @php
                                        ...
                                        <td class="text-nowrap center">
                                            ...
                                            <a href="{{ route('category.edit', $category->id) }}?lang={{$lang}}" class="btn btn-default btn-icon-anim btn-sm btn-circle" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            <a href="#" class="btn btn-danger btn-icon-anim btn-sm btn-circle btn-delete" data-toggle="tooltip" data-type="category" data-name="{{$category->name}}" data-id="{{$category->id}}" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
