                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default card-view">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">Create A Language</h6>
                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group @if($errors->has('title')) has-error @endif">
                                                                        ...
                                                                        {{Form::text('lang_code',null,['class'=>'form-control', 'placeholder' => 'Ex: kh, en,...'])}}
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                        <img class="thum-image" id="thum-image" src="{{ URL('assets/pagebuilder/images') }}/thumbnail_600x400.jpg"/>
